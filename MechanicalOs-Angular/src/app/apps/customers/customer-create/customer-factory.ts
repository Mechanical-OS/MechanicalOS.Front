...
export class CustomerFactory {
  static fromForm(formValue: any): Customer {
    return {
      ...
      dateOfBirth: this.convertNgbDateStructToString(formValue.birthDate) ?? '',
      address: {
        id: formValue.id,
        referenceId: formValue.id,
        country: 'Brasil',
        state: formValue.uf,
        city: formValue.city,
  ...
  static convertNgbDateStructToString(
  ...
  static fromApi(apiResponse: any): Customer {
    return {
      ...
      address: {
        id: apiResponse.address?.id,
        referenceId: apiResponse.address?.referenceId,
